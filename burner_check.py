...
<body>
    ...
    <script>
        ...
        function displayResult(data) {
            ...
            const statusText = data.is_burner 
                ? 'BURNER/VIRTUAL NUMBER DETECTED' 
                : `REAL MOBILE NUMBER - ${data.csv_classification}`;
                ...
                data.records.reverse().forEach(record => {
                    ...
                    tableHTML += `
                        <tr>
                            ...
                            <td>${record.csv_classification}</td>
                            <td>${date}</td>
                        </tr>
                    `;
                });
